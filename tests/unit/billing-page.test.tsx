/**
 * Mesmo padrão de `tests/unit/monitoring-page.test.tsx`: mocka autenticação,
 * organização ativa, Module Engine e branding, e chama a página (Server
...
describe("BillingSettingsPage", () => {
  it("cenário admin: monta sem erro, mostra plano/status e nunca segredo", async () => {
  ...
  it("cenário Lite: monta sem erro e mostra plano Lite", async () => {
  ...
  it("agente não-admin é redirecionado (403), nunca vê o painel", async () => {
    ...
    await expect(BillingSettingsPage()).rejects.toThrow(/redirect/i);
  });
